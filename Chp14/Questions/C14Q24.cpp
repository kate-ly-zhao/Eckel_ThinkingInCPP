//  C14Q24.cpp
/* Take the example CopyConstructor.cpp and modify it by adding your own copy-constructor to Child without
    calling the base-class copy-constructor and see what happens. Fix the problem by making a proper explicit
    call to the base-class copy constructor in the constructor initializer list of the Child copy-constructor.  */
...
public:
    ...
    Child(const Child& c) : Parent(c), i(c.i), m(c.m) { cout << "Child(const Child&)\n"; }
