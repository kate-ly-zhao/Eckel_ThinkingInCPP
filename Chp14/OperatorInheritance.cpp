...
public:
 ...
 // operator= does not inherit, but is synthesized for memberwise assignment.
 // However, only the SameType = SameType operator= is synthesized, so you have to make the others explicitly:
